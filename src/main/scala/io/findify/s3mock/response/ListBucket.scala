...
case class ListBucket(bucket:String, prefix: Option[String], delimiter: Option[String], commonPrefixes: List[String], contents:List[Content], maxKeys: Option[String], isTruncated: Boolean) {
  def toXML =
